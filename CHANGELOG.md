...
- Connections between model objects with metadata
- Tags and technology system for model objects
- Diagram CRUD with schema validation
- React Flow canvas with interactive editor, properties panel, and edge connections
- Internationalization with Paraglide JS (English, Dutch)
- Dark and light theme support
- Docker Compose setup for local development
- Preferences page for account settings
